...
export default function Home() {
  ...
  // Assuming products is the array of products received from the API
const uniqueCategories = Array.from(new Set(products.map(product => product.category)));

// Now uniqueCategories array contains all the unique category values
console.log(uniqueCategories.length); // This will give you the count of unique categories
console.log(uniqueCategories); // This will give you the array of unique categories
...
function ProductCards({ pdata }) {
  ...
  let addToCart = (e) => {
    ...
    // setCarts([...carts, cartObj]);
    toast.success("Your item is added into cart",{position:"bottom-right"});
  };
